    ...
    const handleInputChange = (e) => {
      ...
      const handleSavedetailsbtn = async (event) => {
        ...
        try {
          ...
          const response = await axios.post('/api/v1/courses/createcourse', courseData);
            ...
            <div className='addcoursecolumn'>
                ...
                <div className='adddefaulttabs'>
                    ...
                    <li className='adddefaulttabsli'>
                        <NavLink to="/"><span className='adddefaulttabsspan'>1.</span>Basic Information</NavLink>
                    </li>
                    <li className='adddefaulttabsli'>
                        <NavLink to="/"><span className='adddefaulttabsspan'>2.</span>Media & Images</NavLink>
                    </li>
...
/>
                ...
                <div className='addcoursediv'>
                    <label for="coursename" className="addcourseform-label">Course Title</label>
                    <input type="text" id="coursename" className='addcourseform-input'  placeholder="Enter Course Title" name="coursename" value={courseData.coursename} onChange={handleInputChange}/>
                </div>
                <div className='addcoursediv'>
                    <label for="coursecategory" className="addcourseform-label">Select Category</label>
                    <select id="courseSelection" className="courseselect" name = 'coursecategory'value={courseData.coursecategory} onChange={handleInputChange}>
                ...
                <div className='addcoursediv'>
                    <label for="courselanguage" className="addcourseform-label">Select Language</label>
                    <select id="courseSelection" className='courseselect' name='courselanguage' value={courseData.courselanguage} onChange={handleInputChange}>
                    <option value="" className="courseselectoptions" >Choose Options...</option>
                ...
                <div className='addcoursediv'>
                    <label for="courselevel" className="addcourseform-label">Select Course Level</label>
                    <select id="courseSelection" className='courseselect' name='courselevel'value={courseData.courselevel} onChange={handleInputChange}>
                        <option value="" className="courseselectoptions">Choose Options...</option>
                        {Array.isArray(data2) ? (
                                data2.map((Level) => (
                ...
                <div className='addcoursediv'>
                    <label for="courseprice" className="addcourseform-label">Course Instructor</label>
                    <input type="text"  className='addcourseform-input'placeholder="Enter Course Instructor" name='courseinstructor' value={courseData.courseinstructor} onChange={handleInputChange}/>
                </div>
                <div className='addcoursediv'>
                    <label for="courseprice" className="addcourseform-label">Course Price</label>
                    <input type="number"  className='addcourseform-input'placeholder="Enter Course Price" name='courseprice' value={courseData.courseprice} onChange={handleInputChange}/>
                </div>
                <div className='addcoursediv'>
                    <label for="courseduration" className="addcourseform-label">Course Duration</label>
                    <input type="number"  className='addcourseform-input'placeholder="36 Hours" name='courseduration' value={courseData.courseduration} onChange={handleInputChange}/>
                </div>
                <div className='addcoursediv'>
                ...
                <div className='addcoursediv'>
                    ...
                    <textarea className="addcourseform-textarea2" id="Description" placeholder="Enter Description" name='coursedescription' value={courseData.coursedescription} onChange={handleInputChange}></textarea>
                </div>
                <div className='addcoursebtncontainer'>
                    <button type='submit' className='addcoursebtn' >SaveDetails</button>
                    <ToastContainer/>
                </div>
                </form>
            </div>
