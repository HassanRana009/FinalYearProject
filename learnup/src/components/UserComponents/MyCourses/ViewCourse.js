 ...
 const handleGoBack = () => {
  ...
  <button className="back-arrow-button" onClick={handleGoBack}>
        ...
        <div className='coursedetailscontainer'>
            ...
            <div className='coursedetailscontent' key={course._id}>
              ...
              <p className='coursedetailspara'>{course.courseshortdescription}</p>
              <ul className='coursedetailsul'>
                <li className='coursedetailslu'>
                  <FaStar className='coursedetailsratingicon' />
                  <span className='coursedetailsratingvalue'>{calculateAverageRating(course).toFixed(1)}</span>
                </li>
              </ul>
            </div>
          ))}
    ...
    <div className='coursedetailoverviewcontainer'>
        ...
        {courses.map((course) => (
            <div className='coursedetailoverviewcolumn' key={course._id}>
                ...
                <p className='coursedetailoverviewpara'>{course.coursedescription}</p>
                <h4 className='coursedetailoverviewabout'>Course Subject</h4>
                <p className='coursedetailoverviewpara'>{course.coursesubject}</p>
                <h4 className='coursedetailoverviewabout'>Course Instructor</h4>
                <p className='coursedetailoverviewpara'>{course.courseinstructor}</p>
                <h4 className='coursedetailoverviewabout'>Course Tags</h4>
  ...
  {courses.map((course) => (
    ...
    <div className='coursedetailsingle' key={course._id}>
            <span className='coursedetailsingleprice'>R.s {course.courseprice}</span>
    </div>
     ))}
     {courses.map((course) => (
    <div class="course-feature-list"key={course._id}>
            <ul className='course-feature-listul'>
              <li className='course-feature-listli'>
                 ...
                 <span className='course-feature-listspan'>{course.coursecategory}</span>
              </li>
    </ul>
     </div>
       ))}
    ...
    <div class="course-feature-list"key={course._id}>
            <ul className='course-feature-listul'>
              <li className='course-feature-listli'>
                 ...
                 <span className='course-feature-listspan'>{course.courseduration}</span>
              </li>
    </ul>
     </div>
       ))}
    ...
    <div class="course-feature-list"key={course._id}>
            <ul className='course-feature-listul'>
              <li className='course-feature-listli'>
                 ...
                 <span className='course-feature-listspan'>{course.courselevel}</span>
              </li>
    </ul>
    <div className='startnowcontainer'><button className='startnowbtn' onClick={()=>movecoursedetails(course._id)} >Start Now</button></div>
